const config = {
	//网页元数据
	metaData: {
		title: 'Coccineus的个人主页🎉',
		description: '欢迎来到Coccineus的奇妙世界！',
		keywords: 'Cocineus,Coccineus,个人主页,个人网站',
	...
	//社交按钮
	socialPlatformIcons: [
		{ icon: "mdi-github", link: "https://www.github.com/Azure144" },
		{ icon: "mdi-email", link: "mailto:Auphanim@outlook.com" },
